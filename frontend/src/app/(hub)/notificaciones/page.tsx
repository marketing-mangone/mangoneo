...
const TYPE_CONFIG = {
  kpi_alert: { icon: TrendingUp, color: 'text-[var(--t-f79c31)] bg-[var(--s-fef5e7)]', label: 'KPI' },
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-[var(--t-8888a8)] mt-0.5">{n.message}</p>
                      <p className="text-[10px] text-[var(--t-8888a8)] mt-1.5">{formatRelative(n.createdAt)}</p>
                    </div>
